  ...
  return {
    ...
    choir: {
      ...
      attacks: {
        ...
        C6: { windup: 0.8, rMin: 3, rMax: 13, growTime: 0.5, dps: 70, recovery: 0.8}
      },
    ...
    shepherd: {
      ...
      behavior: { approachDist: 6.0, graveStepRange: 3.5, n5Range: 4, n7Interval: 8.0 },
      risen: {
      ...
      attacks: {
        ...
        N2: { windup: 0.9, spawnDelay: 0.25, recovery: 0.8 },
        ...
        N7: { windup: 2.0, radius: 5.0, safeRadius: 4.5, life: 6.0, recovery: 2.5 },
        N8: { windup: 0.8, arm: 0.4, damage: 28, band: 2.0, length: 20.0, life: 5.0, dps: 8, recovery: 1.0 }
      },
